        ...
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            >
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${formData.is_active
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#53ad35] focus:border-transparent transition-colors ${errors.first_name ? 'border-red-500' : 'border-gray-300'
                                    }`}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                                className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#53ad35] focus:border-transparent transition-colors ${errors.last_name ? 'border-red-500' : 'border-gray-300'
                                    }`}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                                className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#53ad35] focus:border-transparent transition-colors ${errors.email ? 'border-red-500' : 'border-gray-300'
                                    }`}
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={handleInputChange}
                                className={`w-full px-4 py-3 border rounded-xl focus:ring-2 focus:ring-[#53ad35] focus:border-transparent transition-colors ${errors.degree ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            >
                    ...
                    <div className="border-t border-gray-200 pt-6">
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className={`relative inline-flex items-center h-8 w-14 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#53ad35] focus:ring-offset-2 ${formData.is_active ? 'bg-[#53ad35]' : 'bg-gray-300'
                                    }`}
                            >
                                <span
                                    className={`inline-block w-6 h-6 transform rounded-full bg-white transition-transform ${formData.is_active ? 'translate-x-7' : 'translate-x-1'
                                        }`}
                                />
                            </button>
                        </div>
                    ...
                    <div className="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                        ...
                        <button
                            ...
                            className={`px-6 py-3 bg-[#53ad35] text-white rounded-xl font-medium hover:bg-[#34a32a] transition-colors flex items-center space-x-2 ${(saving || !hasChanges()) ? 'opacity-50 cursor-not-allowed' : ''
                                }`}
                        >
                            <FaSave />
